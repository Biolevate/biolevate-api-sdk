...
------------ | ------------- | ------------- | -------------
*AgentApi* | [**create_agent_job**](docs/AgentApi.md#create_agent_job) | **POST** /api/core/agent/jobs | Create agent job
*AgentApi* | [**get_agent_job**](docs/AgentApi.md#get_agent_job) | **GET** /api/core/agent/jobs/{jobId} | Get agent job
*AgentApi* | [**get_agent_job_annotations**](docs/AgentApi.md#get_agent_job_annotations) | **GET** /api/core/agent/jobs/{jobId}/annotations | Get agent job annotations
*AgentApi* | [**get_agent_job_inputs**](docs/AgentApi.md#get_agent_job_inputs) | **GET** /api/core/agent/jobs/{jobId}/inputs | Get agent job inputs
*AgentApi* | [**get_agent_job_outputs**](docs/AgentApi.md#get_agent_job_outputs) | **GET** /api/core/agent/jobs/{jobId}/results | Get agent job outputs
*AgentApi* | [**list_agent_jobs**](docs/AgentApi.md#list_agent_jobs) | **GET** /api/core/agent/jobs | List agent jobs
...
## Documentation For Models
 ...
 - [AgentCompletionConfig](docs/AgentCompletionConfig.md)
 - [AgentInput](docs/AgentInput.md)
 - [AgentJobInputs](docs/AgentJobInputs.md)
 - [AgentJobOutputs](docs/AgentJobOutputs.md)
 ...
 - [Job](docs/Job.md)
 - [JobLaunchConfig](docs/JobLaunchConfig.md)
 - [JobStatistics](docs/JobStatistics.md)
 - [KnowledgeSource](docs/KnowledgeSource.md)
 - [LastMergeJobInfo](docs/LastMergeJobInfo.md)

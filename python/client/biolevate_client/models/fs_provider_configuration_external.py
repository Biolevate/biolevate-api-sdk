...
T = TypeVar("T", bound="FSProviderConfigurationExternal")


@_attrs_define
class FSProviderConfigurationExternal:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fs_provider_configuration_external = cls(
            type_=type_,
        )

        fs_provider_configuration_external.additional_properties = d
        return fs_provider_configuration_external

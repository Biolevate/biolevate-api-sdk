...
class PositionBboxDto(PositionDto):
    """
    PositionBboxDto
    """ # noqa: E501
    bbox: Optional[BboxDto] = None
    page_number: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["type", "bbox", "page_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "bbox": BboxDto.from_dict(obj["bbox"]) if obj.get("bbox") is not None else None,

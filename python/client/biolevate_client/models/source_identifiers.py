...
class SourceIdentifiers(BaseModel):
    ...
    open_access_id: Optional[StrictStr] = Field(default=None, alias="openAccessId")
    __properties: ClassVar[List[str]] = ["doi", "id", "openAccessId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "doi": obj.get("doi"),
            "id": obj.get("id"),
            "openAccessId": obj.get("openAccessId")
        })
        return _obj

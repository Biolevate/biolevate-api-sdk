...
T = TypeVar("T", bound="FSProviderLocalConfigExternal")


@_attrs_define
class FSProviderLocalConfigExternal:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fs_provider_local_config_external = cls(
            name=name,
            type_=type_,
        )

        fs_provider_local_config_external.additional_properties = d
        return fs_provider_local_config_external

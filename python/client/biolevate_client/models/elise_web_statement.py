...
class EliseWebStatement(EliseAnnotationConfig):
    """
    EliseWebStatement
    """ # noqa: E501
    url: Optional[StrictStr] = None
    source: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "url", "source"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EliseWebStatement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EliseWebStatement from a dict"""
        if obj is None:
            return None

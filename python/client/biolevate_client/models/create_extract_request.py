...
T = TypeVar("T", bound="CreateExtractRequest")


@_attrs_define
class CreateExtractRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_extract_request = cls(
            files=files,
            metas=metas,
        )

        create_extract_request.additional_properties = d
        return create_extract_request

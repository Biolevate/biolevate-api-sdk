...
T = TypeVar("T", bound="EliseAnnotationConfig")


@_attrs_define
class EliseAnnotationConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        elise_annotation_config = cls(
            type_=type_,
        )

        elise_annotation_config.additional_properties = d
        return elise_annotation_config

...
class FSProviderSharepointOnlineConfigExternal(FSProviderConfigurationExternal):
    """
    FSProviderSharepointOnlineConfigExternal
    """ # noqa: E501
    site_url: StrictStr = Field(alias="siteUrl")
    document_library: StrictStr = Field(alias="documentLibrary")
    tenant_id: StrictStr = Field(alias="tenantId")
    __properties: ClassVar[List[str]] = ["type", "siteUrl", "documentLibrary", "tenantId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documentLibrary": obj.get("documentLibrary"),

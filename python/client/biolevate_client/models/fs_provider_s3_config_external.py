...
T = TypeVar("T", bound="FSProviderS3ConfigExternal")


@_attrs_define
class FSProviderS3ConfigExternal:
    """
    Attributes:
        bucket_name (str):
        region (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fs_provider_s3_config_external = cls(
            bucket_name=bucket_name,
            region=region,
            type_=type_,
        )

        fs_provider_s3_config_external.additional_properties = d
        return fs_provider_s3_config_external

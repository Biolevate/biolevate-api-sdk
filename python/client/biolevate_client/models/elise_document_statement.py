...
T = TypeVar("T", bound="EliseDocumentStatement")


@_attrs_define
class EliseDocumentStatement:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        elise_document_statement.additional_properties = d
        return elise_document_statement
